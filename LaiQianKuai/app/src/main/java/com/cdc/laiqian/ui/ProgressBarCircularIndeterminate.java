...
import com.cdc.laiqian.R;
import com.cdc.laiqian.util.Util;
...
public class ProgressBarCircularIndeterminate extends CustomView {
    ...
    private void k(Canvas paramCanvas) {
        ...
        this.anR.setColor(getResources().getColor(R.color.deletebtn_end_color));
        ...
        if (this.dwv >= 50) {
            ...
            float f;
            if (this.dwu >= (getWidth() / 2 - Util.b(3.0F, getResources()))) {
                f = getWidth() / 2.0F - Util.b(3.0F, getResources());
            } else {
                f = 1.0F + this.dwu;
            }
            this.dwu = f;
    ...
    private void l(Canvas paramCanvas) {
        ...
        this.anR.setColor(getResources().getColor(R.color.deletebtn_end_color));
        this.anR.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        canvas.drawCircle((getWidth() / 2), (getHeight() / 2), (getWidth() / 2 - Util.b(3.0F, getResources())), this.anR);
        paramCanvas.drawBitmap(bitmap, 0.0F, 0.0F, null);
    }
    ...
    public void setBackgroundColor(int paramInt) {
        super.setBackgroundColor(getResources().getColor(R.color.deletebtn_end_color));
        if (isEnabled())
    ...
    class P implements Runnable{
        P(ProgressBarCircularIndeterminate paramProgressBarCircularIndeterminate) {
