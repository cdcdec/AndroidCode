...
import com.bigkoo.alertview.MyAlertView;
...
public class MainActivity extends Activity implements OnItemClickListener, OnDismissListener {
    ...
    public void alertShowCustom(View view){
        AlertView alertView=new AlertView("","","",null,null,this, AlertView.Style.Alert,this).setCancelable(true);
