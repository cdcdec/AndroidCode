package com.cdc.mapsearchlocation;
...
public class MapSearchLocationMainActivity extends AppCompatActivity implements LocationSource,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_search_location_main);
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(MapSearchLocationMainActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    InputtipsQuery inputquery = new InputtipsQuery(newText, "漯河");
                    Inputtips inputTips = new Inputtips(MapSearchLocationMainActivity.this, inputquery);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(MapSearchLocationMainActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(MapSearchLocationMainActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(MapSearchLocationMainActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(MapSearchLocationMainActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
