...
public class ab extends o {
  ...
  public ab(Activity paramActivity, n paramn, o.a parama) { super(paramActivity, R.layout.dialog_online_lqk_pay, paramn, parama); }
    ...
    if (paramInt1 != -1) {
      if (paramInt1 != 4) {
        if (paramInt1 != 6) {
          ...
          this.aAw.setOnClickListener(new ad(this, paramString2));
          this.aAx.setVisibility(8);
...
/* Location:              F:\chrome_download\android-Decompile\dex2jar-2.0\classes-dex2jar.jar!\com\laiqian\ab.class
