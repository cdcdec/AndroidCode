...
public class LayoutLeftTextRightCheckboxOnlineMemberSwitch extends FrameLayout {
  ...
  public LayoutLeftTextRightCheckboxOnlineMemberSwitch(@NonNull Context paramContext) { this(paramContext, null); }
  
  public LayoutLeftTextRightCheckboxOnlineMemberSwitch(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet) { this(paramContext, paramAttributeSet, 0); }
  
  public LayoutLeftTextRightCheckboxOnlineMemberSwitch(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt) {
  ...
  public CheckBox aqT() { return this.dxk; }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent) {
    if (this.dxm != null && this.dxk != null && this.dxk.isEnabled()) {
...
/* Location:              F:\chrome_download\android-Decompile\dex2jar-2.0\classes2-dex2jar.jar!\com\laiqia\\ui\container\LayoutLeftTextRightCheckboxOnlineMemberSwitch.class
