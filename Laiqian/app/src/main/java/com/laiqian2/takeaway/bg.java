...
class bg implements e.a {
  bg(bc parambc, e parame, String paramString) {}
  ...
  public void a(e parame, int paramInt) {
    ...
    if (paramInt == 4)
      a.aKh().r(new bh(this, this.dtT)); 
  }
}


/* Location:              F:\chrome_download\android-Decompile\dex2jar-2.0\classes2-dex2jar.jar!\com\laiqian\takeaway\bg.class
