...
public class SmartOrderSettingsFragment extends FragmentRoot {
  ...
  private void setListeners() {
    this.cec.setOnClickListener(new k(this));
    this.ced.setOnCheckedChangeListener(new l(this));
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
    View view = LayoutInflater.from(getActivity()).inflate(2131427613, null);
...
/* Location:              F:\chrome_download\android-Decompile\dex2jar-2.0\classes2-dex2jar.jar!\com\laiqian\ordertool\smartorder\SmartOrderSettingsFragment.class
