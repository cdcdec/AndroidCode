...
public class UpgradeAndEvaluate extends Activity {
  ...
  private void initData() {
    ...
    if (this.dHY != null) {
      ...
      if (this.dIa != null && !"null".equals(this.dIa)) {
        ...
        stringBuilder1.append("currentVersionList=");
        stringBuilder1.append(this.dIa);
        bb.ao(stringBuilder1.toString());
        b b = new b(this, this, this.dIa);
        this.dHX.setAdapter(b);
      } else {
  ...
  private void wZ() {
    ...
    this.dHV = (LinearLayout)findViewById(R.id.llHistoryVersion);
    this.dHX = (ScalableListView)findViewById(R.id.lvCurrentVersion);
    ...
    this.dHW = (LinearLayout)findViewById(R.id.llCurrentVersion);
    this.dHU = (TextView)findViewById(R.id.tvNewVersionSize);
    this.dHZ = (TextView)findViewById(R.id.tvClientVersionName);
  ...
  private class a extends BroadcastReceiver {
    private a(UpgradeAndEvaluate this$0) {}
    
    public void onReceive(Context param1Context, Intent param1Intent) {
      Bundle bundle = param1Intent.getExtras();
      this.dIp.progress = bundle.getInt("progress");
      bundle.getBoolean("sDownloadStatus");
      StringBuilder stringBuilder1 = new StringBuilder();
      stringBuilder1.append("Activity中的进度");
      stringBuilder1.append(this.dIp.progress);
      stringBuilder1.append("%");
      bb.ao(stringBuilder1.toString());
      if (this.dIp.progress == 100) {
        Message message = new Message();
        message.obj = "1";
        this.dIp.dIm.sendMessage(message);
        return;
      } 
      TextView textView = UpgradeAndEvaluate.a(this.dIp);
      StringBuilder stringBuilder2 = new StringBuilder();
      stringBuilder2.append("(");
      stringBuilder2.append(this.dIp.getString(R.string.pos_downloading));
      stringBuilder2.append(this.dIp.progress);
      stringBuilder2.append("%)");
      textView.setText(stringBuilder2.toString());
    }
  }
  ...
  class b extends BaseAdapter {
    ...
    public b(UpgradeAndEvaluate this$0, Context param1Context, ArrayList<HashMap<String, String>> param1ArrayList) {
    ...
    public View getView(int param1Int, View param1View, ViewGroup param1ViewGroup) {
      ...
      if ("GOOD".equals(str)) {
        ...
        button2.setTextColor(this.dIp.getResources().getColor(R.color.black));
        button1.setText(R.string.pos_upgrade_ever_good_evaluate);
        button1.setTextColor(this.dIp.getResources().getColor(R.color.member_list_item_min));
      ...
      if ("BAD".equals(str)) {
        ...
        button2.setTextColor(this.dIp.getResources().getColor(R.color.member_list_item_min));
        button1.setText(R.string.pos_upgrade_good_evaluate);
        button1.setTextColor(this.dIp.getResources().getColor(R.color.black));
...
/* Location:              F:\chrome_download\android-Decompile\dex2jar-2.0\classes2-dex2jar.jar!\com\laiqian\version\UpgradeAndEvaluate.class
