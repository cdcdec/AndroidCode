...
public class ReceiptPrintSettings implements f, b, Serializable {
  private int cCC = 1;
  ...
  public static boolean ma(String paramString) { return !(paramString == null); }
  
  public int aiM() { return this.cNK; }
  
  public boolean aiN() { return this.cNG; }
  
  public boolean aiO() { return this.cNH; }
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == null)
      return false; 
    if (!(paramObject instanceof ReceiptPrintSettings))
      return false; 
    paramObject = (ReceiptPrintSettings)paramObject;
    return (this.width != paramObject.width) ? false : ((this.cCC != paramObject.cCC) ? false : (!by.bw(this.title, paramObject.title) ? false : (!by.bw(this.cMC, paramObject.cMC) ? false : ((this.cMD != paramObject.cMD) ? false : ((this.cME != paramObject.cME) ? false : ((this.cMF != paramObject.cMF) ? false : ((this.cMG != paramObject.cMG) ? false : (!by.bw(this.cMH, paramObject.cMH) ? false : ((this.cMI != paramObject.cMI) ? false : (!by.bw(this.cMJ, paramObject.cMJ) ? false : ((this.cNG != paramObject.cNG) ? false : ((this.cNH != paramObject.cNH) ? false : (!(this.cNK != paramObject.cNK))))))))))))));
  }
  
  public void fX(boolean paramBoolean) { this.cNG = paramBoolean; }
  
  public void gd(boolean paramBoolean) { this.cNH = paramBoolean; }
  ...
  public void iY(int paramInt) { this.cNK = paramInt; }
...
/* Location:              F:\chrome_download\android-Decompile\dex2jar-2.0\classes2-dex2jar.jar!\com\laiqian\prin\\usage\receipt\model\ReceiptPrintSettings.class
