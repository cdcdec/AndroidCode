...
import com.example.gsyvideoplayer.customui.CustomUiActivity;
...
public class JumpUtils {
     ...
     * @param activity
     */
    public static void goToCustomUiVideoPlayer(Activity activity) {
        Intent intent = new Intent(activity, CustomUiActivity.class);
