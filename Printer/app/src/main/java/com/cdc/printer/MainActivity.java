...
public class MainActivity extends AppCompatActivity {
    ...
    public void setUsb(View view) {
        try {

            int rel = mGpService.openPort(0, PortParameters.USB,"/dev/bus/usb/001/007",0);
            Log.i("ServiceConnection", "rel " + rel);
            GpCom.ERROR_CODE r = GpCom.ERROR_CODE.values()[rel];
            if (r != GpCom.ERROR_CODE.SUCCESS) {
                Log.i("ServiceConnection", "error text= " + GpCom.getErrorText(r));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("12345","density="+density+",densityDpi="+densityDpi+",width="+width+",height="+height);
   ...
   /* public boolean[] getConnectState() {
    ...
    void sendReceipt() {
        ...
        esc.addSelectPrintModes(EscCommand.FONT.FONTA, ENABLE.OFF, ENABLE.ON, ENABLE.ON, ENABLE.OFF);// 设置为倍高倍宽
        esc.addText("Sample\n"); // 打印文字
