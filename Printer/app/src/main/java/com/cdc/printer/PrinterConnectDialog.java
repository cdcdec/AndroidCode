...
public class PrinterConnectDialog extends Activity {
	private final static String TAG = "PrinterConnectDialog";
	...
	private void initPortParam() {
		...
		Log.e(TAG,state.length+"==state boolean 的长度");
	...
	private String getPortParamInfoString(PortParameters Param) {
		...
		Log.e(TAG, "Param.getPortType() " + type);
	...
	class TitelItemOnLongClickLisener implements OnItemLongClickListener {
		...
		public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			// TODO Auto-generated method stub
			Log.e(TAG, "TitelItemOnLongClickLisener " + arg2);
		...
		if (mPortParam[PrinterId].getPortOpenState() == false) {
			if (CheckPortParamters(mPortParam[PrinterId])) {
				...
				case PortParameters.USB:
					try {
                        Log.e(TAG,"PrinterId="+PrinterId);
                        int portType=mPortParam[PrinterId].getPortType();
						Log.e(TAG,"portType="+portType+"=="+PortParameters.USB);
						String dName=mPortParam[PrinterId].getUsbDeviceName();
