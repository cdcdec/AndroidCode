...
public class JpushMainActivity extends BaseActivity {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.init:
                ...
                break;
            case R.id.setting:
                Intent intent = new Intent(JpushMainActivity.this, PushingSettingActivity.class);
    ...
    @Override
    public int layoutId() {
        return R.layout.activity_jpush_main;
    }
}
