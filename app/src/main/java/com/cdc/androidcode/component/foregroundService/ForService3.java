...
public class ForService3 extends Service {
    ...
    public static boolean trigger(Context context) {
        ...
        if (!start) {
            context.startService(new Intent(context, ForService3.class));
        } else {
            if (Build.VERSION.SDK_INT < 18) {
                context.stopService(new Intent(context, ForService3.class));
            } else {
